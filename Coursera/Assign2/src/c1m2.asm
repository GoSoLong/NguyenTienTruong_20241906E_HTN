...
0000000000000368 <.note.gnu.build-id>:
 ...
 377:	00 74 05 e7          	add    %dh,-0x19(%rbp,%rax,1)
 37b:	fe                   	(bad)
 37c:	f3 10 ba 7d 1c 84 81 	repz adc %bh,-0x7e7be383(%rdx)
 383:	1e                   	(bad)
 384:	b4 00                	mov    $0x0,%ah
 386:	ec                   	in     (%dx),%al
 387:	cc                   	int3
 388:	39                   	.byte 0x39
 389:	99                   	cltd
...
0000000000000000 <.debug_info>:
 ...
 14a:	0c 47                	or     $0x47,%al
 14c:	00 00                	add    %al,(%rax)
 14e:	00 07                	add    %al,(%rdi)
...
0000000000000000 <.debug_line>:
  ...
  bf:	1f                   	(bad)
  c0:	01 07                	add    %eax,(%rdi)
  c2:	00 00                	add    %al,(%rax)
  c4:	00 02                	add    %al,(%rdx)
  c6:	01 1f                	add    %ebx,(%rdi)
  c8:	02 0f                	add    (%rdi),%cl
  ca:	02 47 00             	add    0x0(%rdi),%al
  cd:	00 00                	add    %al,(%rax)
  cf:	00 47 00             	add    %al,0x0(%rdi)
  d2:	00 00                	add    %al,(%rax)
...
0000000000000000 <.debug_line_str>:
   0:	6d                   	insl   (%dx),%es:(%rdi)
   1:	61                   	(bad)
   2:	69 6e 2e 63 00 2f 6d 	imul   $0x6d2f0063,0x2e(%rsi),%ebp
   9:	6e                   	outsb  %ds:(%rsi),(%dx)
   a:	74 2f                	je     3b <__abi_tag-0x351>
   c:	64 2f                	fs (bad)
   e:	63 6f 64             	movsxd 0x64(%rdi),%ebp
  11:	65 2f                	gs (bad)
  13:	48 54                	rex.W push %rsp
  15:	4e 2f                	rex.WRX (bad)
  17:	43 6f                	rex.XB outsl %ds:(%rsi),(%dx)
  19:	75 72                	jne    8d <__abi_tag-0x2ff>
  1b:	73 65                	jae    82 <__abi_tag-0x30a>
  1d:	72 61                	jb     80 <__abi_tag-0x30c>
  1f:	2f                   	(bad)
  20:	41 73 73             	rex.B jae 96 <__abi_tag-0x2f6>
  23:	69 67 6e 32 2f 73 72 	imul   $0x72732f32,0x6e(%rdi),%esp
  2a:	63 00                	movsxd (%rax),%eax
  2c:	2e 2e 2f             	cs cs (bad)
  2f:	69 6e 63 6c 75 64 65 	imul   $0x6564756c,0x63(%rsi),%ebp
  36:	2f                   	(bad)
  37:	63 6f 6d             	movsxd 0x6d(%rdi),%ebp
  3a:	6d                   	insl   (%dx),%es:(%rdi)
  3b:	6f                   	outsl  %ds:(%rsi),(%dx)
  3c:	6e                   	outsb  %ds:(%rsi),(%dx)
  3d:	00 6d 65             	add    %ch,0x65(%rbp)
  40:	6d                   	insl   (%dx),%es:(%rdi)
  41:	6f                   	outsl  %ds:(%rsi),(%dx)
  42:	72 79                	jb     bd <__abi_tag-0x2cf>
  44:	2e 68 00 6d 65 6d    	cs push $0x6d656d00
  4a:	6f                   	outsl  %ds:(%rsi),(%dx)
  4b:	72 79                	jb     c6 <__abi_tag-0x2c6>
  4d:	2e 63 00             	cs movsxd (%rax),%eax
